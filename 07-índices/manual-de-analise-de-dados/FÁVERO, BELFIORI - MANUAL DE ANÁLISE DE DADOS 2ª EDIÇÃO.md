...
tags:
  ...
  - python
  - R
repo: https://github.com/dvths/sql-para-analise-de-dados
---
...
FROM 
	"04-notas-de-literatura"
WHERE file.cday > (date(today) - dur(7 days)) and titulo_livro = "Manual de Análise de Dados"
SORT file.cday desc
LIMIT
	10
```
...
FROM
	"04-notas-de-literatura"
WHERE
	titulo_livro = "Manual de Análise de Dados" and sr-due
SORT 
	file.mday desc
```
...
WHERE file.tasks and titulo_livro = "Manual de Análise de Dados"
