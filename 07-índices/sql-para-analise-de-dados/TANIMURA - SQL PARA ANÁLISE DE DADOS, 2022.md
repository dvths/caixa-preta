...
FROM 
	"04-notas-de-literatura"
WHERE file.cday > (date(today) - dur(7 days)) and titulo_livro = "SQL para Análise de Dados"
SORT file.cday desc
LIMIT
	10
```
...
FROM
	"04-notas-de-literatura"
WHERE
	titulo_livro = "SQL para Análise de Dados" and sr-due
SORT 
	file.mday desc
```
...
WHERE file.tasks and titulo_livro = "SQL para Análise de Dados"
