...
FROM 
	"04-notas-de-literatura"
WHERE file.cday > (date(today) - dur(7 days)) and titulo_livro = "Python in a Nutshell"
SORT file.cday desc
LIMIT
	10
```
...
WHERE file.tasks and titulo_livro = "Python in a Nutshell"
...
table without id
	...
	file.ctime as Data
 from "04-notas-de-literatura"
 where contains(topico, "<Nome do tópico>")
`